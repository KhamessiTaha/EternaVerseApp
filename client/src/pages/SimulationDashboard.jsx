  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-black text-white">
      ...
      <div className="mt-8 grid grid-cols-2 gap-6 text-lg bg-gray-800 p-6 rounded-lg shadow-lg">
        <div>
          <span className="text-gray-400">Age:</span> {universeStats.age} years
        </div>
        <div>
          <span className="text-gray-400">Expansion Rate:</span> {universeStats.expansionRate.toFixed(2)}x
        </div>
        <div>
          <span className="text-gray-400">Entropy:</span> {universeStats.entropy.toFixed(2)}
        </div>
        <div>
          <span className="text-gray-400">Life Probability:</span> {(universeStats.lifeProbability * 100).toFixed(1)}%
        </div>
      </div>
